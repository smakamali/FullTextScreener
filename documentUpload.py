...
def save_wikipedia_pages(title_list, output_dir="documents", fail_log="failed_titles.txt"):
    """
...
def retry_failed_titles(failed_file="failed_titles.txt", output_dir="documents", detailed_log="detailed_failed_log.txt"):
    """
...
def handle_manual_titles(titles, output_dir="documents", fail_log="new_failed_titles.txt"):
    """
...
def check_downloaded_titles(titles, folder="documents"):
    """
